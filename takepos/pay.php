...
?>
	...
	function Validate(payment)
	{
		...
		// Mahmoud Kamal . this request to get invoice type then if credit note send validate request
        $.ajax({
            type: "GET",
            url: "invoice.php?place=<?php echo $place; ?>&action=invoiceType&invoiceid="+invoiceid,
