...
if ($action == 'valid' && $user->rights->facture->creer) {
	...
	if (!$error && $res >= 0) {
        ...
        if ($invoice->type === Facture::TYPE_CREDIT_NOTE) {
            //Mahmoud Kamal
            // هنا بيرجع القيمه بالسالب ف ضربتها فى سالب عشان يدهالى موجب واكمل عليها الشرط
...
if ($action == 'creditnote' && $user->rights->facture->creer) {
    ...
    // هنا بضيف خطوه زياده عشان اعرف فى كميات متاحه ولا لا
    // Mahmoud Kamal add
	...
	$creditnote->pos_source = $_SESSION["takeposterminal"];
...
if ($action == "updateqty") {
    ...
    // هنا بضيف خطوه زياده عشان اعرف الكمية الى دخلها اكبر ولا اصغر ولا اقل
    // Mahmoud Kamal add
